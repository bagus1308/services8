...
const url = 'https://enigmatic-castle-66114.herokuapp.com/pengguna';

const lstCari = ["All","userNama","userEmail","userPhone","userAddress"]
const Home = ({navigation}) => {
  ...
  const renderItemHeader = (headerProps, info) => (
    <View {...headerProps}>
      <Text category='h6'>
        Name     : {info.item.userNama} 
      </Text>
      <Text category='h6'>
        Email     : {info.item.userEmail} 
      </Text>
      <Text category='h6'>
        Phone    : {info.item.userPhone} 
      </Text>
      <Text category='h6'>
        Address : {info.item.userAddress} 
      </Text>
    </View>
  );
